...
export default function TaskGenerationPage() {
  ...
  const returnUrl = searchParams.get('returnUrl') || '/dashboard/tasks';
  ...
  const applyDateRange = () => {
    ...
    router.replace(`/dashboard/tasks/generate?${params.toString()}`, { scroll: false });
  };
          ...
          <CardContent>
            {loading ? (
              ...
              <div className="text-center text-gray-500 py-8">
                ...
                <Button onClick={() => router.push('/dashboard/tasks/templates')}>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-4 text-xs text-gray-500">
                          ...
                          {template.defaultDueTime && <span>Due: {template.defaultDueTime}</span>}
                          <span>
                            Assignees:{' '}
