...
export default function SessionDetailsPage() {
  ...
  const returnUrl = searchParams.get('returnUrl') || '/dashboard/cashbox';
  ...
  const handleViewSession = (sessionId: string) => {
    ...
    const returnUrl = `/dashboard/cashbox/sessions?${currentParams.toString()}`;
    params.set('returnUrl', returnUrl);
    router.push(`/dashboard/cashbox/sessions/${sessionId}?${params.toString()}`);
  };
        ...
        <CardContent>
          <SessionsTable
            ...
            onEditSession={(sessionId) => {
              ...
              router.push(`/dashboard/cashbox/sessions/${sessionId}/edit?${params.toString()}`);
            }}
